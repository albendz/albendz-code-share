...
class CopyNotFoundException(isbn: String, copyId: UUID) :
    LibraryApiException("Copy with ID $copyId and book $isbn not found", HttpStatus.NOT_FOUND)
...
class InvalidSearchRequestException : LibraryApiException("Invalid search request", HttpStatus.BAD_REQUEST)